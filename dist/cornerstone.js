/*! cornerstone-core - 2.0.0 - 2018-02-01 | (c) 2016 Chris Hafey | https://github.com/cornerstonejs/cornerstone */
...
var _renderLabelMapImage = __webpack_require__(25);
...
var _renderPseudoColorImage = __webpack_require__(26);
...
Object.defineProperty(exports, 'registerContentManager', {
  enumerable: true,
  get: function get() {
    return _imageLoader.registerContentManager;
  }
});
...
exports.registerContentManager = registerContentManager;
...
function loadImage(imageId, options) {
  ...
  var colonIndex = imageId.indexOf(':');
  var scheme = imageId.substring(0, colonIndex);
  var contentManager = contentManagers[scheme];
 ...
 * @returns {void}
 */
function registerContentManager(scheme, contentManager) {
